  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.logoSection}>
        ...
        <Text style={styles.tagline}>Smart Shopping. No Waiting.</Text>
      </View>

      <View style={styles.illustrationSection}>
        {/* Shopping basket emoji illustration style */}
        ...
        <Text style={styles.infoTitle}>Smart Shopping{"\n"}No Waiting!</Text>
        <Text style={styles.infoSubtitle}>Scan, Shop & Skip the Queue</Text>
      </View>
      ...
      <View style={styles.buttonSection}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('Login')}
        >
          <Text style={styles.loginText}>Have an account? <Text style={styles.loginLink}>Login</Text></Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  btnLoginLink: { alignSelf: 'center', marginTop: Spacing.lg },
  loginText: { fontSize: FontSize.sm, color: Colors.textMuted, fontWeight: FontWeight.medium },
